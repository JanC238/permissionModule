            ...
            <div class="row">
                <div class="pageheader" style="padding:0px 10px 10px 10px; border-bottom:0px; background:#FFF">
                    ...
                    <div style="width:100%; padding:10px 0 10px 10px; margin-top:10px;">
                        <?php if(in_array('/AdMenu/add',per()) OR user()['id'] == 1): ?><a href="<?php echo U('/AdMenu/add');?>" class="btn btn-add"><i class="fa fa-plus"></i> 添加</a><?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="row m-top-md">
                <div class="col-lg-12 col-sm-6">
                    <table width="100%" class="tables m-top-md table-hover table-striped">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$first): $mod = ($i % 2 );++$i; if(($first['tid']) == "0"): ?><tr class="text-c">
                                    <td><?php echo ($first["name"]); ?></td>
                                    <td><?php echo ($first["url"]); ?></td>
                                    <td><?php echo ($first["sort"]); ?></td>
                                    <td>
                                        <?php if(in_array('AdMenu/change',per()) OR user()['id'] == 1): if($first["set"] == 1): ?><a name="<?php echo ($first["id"]); ?>" class="btn btn-infos btnset">展示中</a>
                                                <?php else: ?>
                                                <a name="<?php echo ($first["id"]); ?>" class="btn btn-info btnset">不展示</a><?php endif; endif; ?>
                                        <?php if(in_array('/AdMenu/edit',per()) OR user()['id'] == 1): ?><a href="<?php echo U('/AdMenu/edit',['mid'=>$first['id']]);?>"
                                               class="btn btn-infos">编辑</a><?php endif; ?>

                                        <?php if(in_array('/AdMenu/del',per()) OR user()['id'] == 1): ?><a name="<?php echo ($first["id"]); ?>" class="btn btn-infos btndel">删除</a><?php endif; ?>
                                    </td>
                                </tr>
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$second): $mod = ($i % 2 );++$i; if($second["tid"] == $first["id"] && $second["pid"] == 0): ?><tr class="text-c">
                                            <td>|------<?php echo ($second["name"]); ?></td>
                                            <td><?php echo ($second["url"]); ?></td>
                                            <td><?php echo ($second["sort"]); ?></td>
                                            <td>
                                                <?php if(in_array('AdMenu/change',per()) OR user()['id'] == 1): if($second["set"] == 1): ?><a name="<?php echo ($second["id"]); ?>" class="btn btn-infos btnset">展示中</a>
                                                        <?php else: ?>
                                                        <a name="<?php echo ($second["id"]); ?>" class="btn btn-info btnset">不展示</a><?php endif; endif; ?>
                                                <?php if(in_array('/AdMenu/edit',per()) OR user()['id'] == 1): ?><a href="<?php echo U('/AdMenu/edit',['mid'=>$second['id']]);?>"
                                                       class="btn btn-infos">编辑</a><?php endif; ?>

                                                <?php if(in_array('/AdMenu/del',per()) OR user()['id'] == 1): ?><a name="<?php echo ($second["id"]); ?>" class="btn btn-infos btndel">删除</a><?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$third): $mod = ($i % 2 );++$i; if(($third['pid']) == $second['id']): ?><tr class="text-c">
                                                    <td>|-------------<?php echo ($third["name"]); ?></td>
                                                    <td><?php echo ($third["url"]); ?></td>
                                                    <td><?php echo ($third["sort"]); ?></td>
                                                    <td>
                                                        <?php if(in_array('AdMenu/change',per()) OR user()['id'] == 1): if($third["set"] == 1): ?><a name="<?php echo ($third["id"]); ?>" class="btn btn-infos btnset">展示中</a>
                                                                <?php else: ?>
                                                                <a name="<?php echo ($third["id"]); ?>" class="btn btn-info btnset">不展示</a><?php endif; endif; ?>
                                                        <?php if(in_array('/AdMenu/edit',per()) OR user()['id'] == 1): ?><a href="<?php echo U('/AdMenu/edit',['mid'=>$third['id']]);?>"
                                                               class="btn btn-infos">编辑</a><?php endif; ?>

                                                        <?php if(in_array('/AdMenu/del',per()) OR user()['id'] == 1): ?><a name="<?php echo ($third["id"]); ?>" class="btn btn-infos btndel">删除</a><?php endif; ?>
                                                    </td>
                                                </tr>
                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fourth): $mod = ($i % 2 );++$i; if(($fourth['pid']) == $third['id']): ?><tr class="text-c">
                                                            <td>|---------------------<?php echo ($fourth["name"]); ?></td>
                                                            <td>　　　　<?php echo ($fourth["url"]); ?></td>
                                                            <td><?php echo ($fourth["sort"]); ?></td>
                                                            <td>
                                                                <?php if(in_array('AdMenu/change',per()) OR user()['id'] == 1): if($fourth["set"] == 1): ?><a name="<?php echo ($fourth["id"]); ?>" class="btn btn-infos btnset">展示中</a>
                                                                        <?php else: ?>
                                                                        <a name="<?php echo ($fourth["id"]); ?>" class="btn btn-info btnset">不展示</a><?php endif; endif; ?>
                                                                <?php if(in_array('/AdMenu/edit',per()) OR user()['id'] == 1): ?><a href="<?php echo U('/AdMenu/edit',['mid'=>$fourth['id']]);?>"
                                                                       class="btn btn-infos">编辑</a><?php endif; ?>

                                                                <?php if(in_array('/AdMenu/del',per()) OR user()['id'] == 1): ?><a name="<?php echo ($fourth["id"]); ?>" class="btn btn-infos btndel">删除</a><?php endif; ?>
                                                            </td>
                                                        </tr><?php endif; endforeach; endif; else: echo "" ;endif; endif; endforeach; endif; else: echo "" ;endif; endif; endforeach; endif; else: echo "" ;endif; endif; endforeach; endif; else: echo "" ;endif; ?>
                        <!--<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vb): $mod = ($k % 2 );++$k;?>-->
                        <!--<tr class="text-c">-->
                        <!--<td><?php echo ($vb["name"]); ?></td>-->
                        <!--<td><?php echo ($vb["url"]); ?></td>-->
                        <!--<td><?php echo ($vb["sort"]); ?></td>-->
                        <!--<td>-->
                        <!--<?php if($vb["set"] == 1): ?>-->
                        <!--<a name="<?php echo ($vb["id"]); ?>" class="btn btn-infos btnset">展示中</a>-->
                        <!--<?php else: ?>-->
                        <!--<a name="<?php echo ($vb["id"]); ?>" class="btn btn-info btnset">不展示</a>-->
                        <!--<?php endif; ?>-->
                        <!--<a href="<?php echo U('/AdMenu/edit',['mid'=>$vb['id']]);?>" class="btn btn-infos">编辑</a>-->
                        <!--<a name="<?php echo ($vb["id"]); ?>" class="btn btn-infos btndel">删除</a>-->
                        <!--</td>-->
                        <!--</tr>-->
                        <!--<?php if(is_array($vb['_child'])): $i = 0; $__LIST__ = $vb['_child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vc): $mod = ($i % 2 );++$i;?>-->
                        <!--<tr class="text-c">-->
                        <!--<td>|&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;<?php echo ($vc["name"]); ?></td>-->
                        <!--<td><?php echo ($vc["url"]); ?></td>-->
                        <!--<td><?php echo ($vc["sort"]); ?></td>-->
                        <!--<td>-->
                        <!--<?php if($vc["set"] == 1): ?>-->
                        <!--<a name="<?php echo ($vc["id"]); ?>" class="btn btn-infos btnset">展示中</a>-->
                        <!--<?php else: ?>-->
                        <!--<a name="<?php echo ($vc["id"]); ?>" class="btn btn-info btnset">不展示</a>-->
                        <!--<?php endif; ?>-->
                        <!--<a href="<?php echo U('/AdMenu/edit',['mid'=>$vc['id']]);?>" class="btn btn-infos">编辑</a>-->
                        <!--<a name="<?php echo ($vc["id"]); ?>" class="btn btn-infos btndel">删除</a>-->
                        <!--</td>-->
                        <!--</tr>-->
                        <!--<?php if(is_array($vc['_child'])): $i = 0; $__LIST__ = $vc['_child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vd): $mod = ($i % 2 );++$i;?>-->
                        <!--<tr class="text-c">-->
                        <!--<td>|-&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;<?php echo ($vd["name"]); ?></td>-->
                        <!--<td><?php echo ($vd["url"]); ?></td>-->
                        <!--<td><?php echo ($vd["sort"]); ?></td>-->
                        <!--<td>-->
                        <!--<?php if($vd["set"] == 1): ?>-->
                        <!--<a name="<?php echo ($vd["id"]); ?>" class="btn btn-infos btnset">展示中</a>-->
                        <!--<?php else: ?>-->
                        <!--<a name="<?php echo ($vd["id"]); ?>" class="btn btn-info btnset">不展示</a>-->
                        <!--<?php endif; ?>-->
                        <!--<a href="<?php echo U('/AdMenu/edit',['mid'=>$vd['id']]);?>" class="btn btn-infos">编辑</a>-->
                        <!--<a name="<?php echo ($vd["id"]); ?>" class="btn btn-infos btndel">删除</a>-->
                        <!--</td>-->
                        <!--</tr>-->
                        ...
                        <tr>
                            <td colspan='6'>
                                <ul class="pagination" style="margin:0;"><?php echo ($page); ?></ul>
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
    ...
    $(".btndel").on("click", function () {
        if (confirm("确定要删除数据吗")) {
            $.maskajax('post', "<?php echo U('/AdMenu/del');?>", {"id": $(this).attr("name")}, function (data) {
                if (data.status == 0) {
                    alert(data.msg);
                } else {
                    location.reload();
    ...
    $(".btnset").on('click', function () {
        $.maskajax('post', "<?php echo U('/AdMenu/change');?>", {"id": $(this).attr("name")}, function (data) {
